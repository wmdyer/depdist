...
def make_mlp_model():
  ...
  Returns:
    A Sonnet module which contains the MLP and LayerNorm.
  """
  print("make model of " + str(NUM_LAYERS) + " layers / " + str(LATENT_SIZE) + " neurons")
  return snt.Sequential([
...
class MLPGraphNetwork(snt.AbstractModule):
  ...
  def __init__(self, name="MLPGraphNetwork"):
    ...
    with self._enter_variable_scope():
      self._network = modules.GraphNetwork(make_mlp_model_full, make_mlp_model_full,
                                           make_mlp_model_full)
...
class EncodeProcessDecode(snt.AbstractModule):
  ...
  def __init__(self,
    ...
    #NUM_LAYERS = nlayers
    #LATENT_SIZE = nsize
    print("making GNN encode-decode with " + str(NUM_LAYERS) + " layers / " + str(LATENT_SIZE) + " neurons")
